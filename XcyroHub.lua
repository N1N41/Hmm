...
_G.Primary = Color3.fromRGB(0, 105, 148)
_G.Dark = Color3.fromRGB(0, 105, 148)
----------------------------------------------------------------------------------------------------------------------------------------
_G.TieuDe = "Xcyro Hub | Blox Fruit"
_G.Xcyro = "By Mirai209"
_G.Thông baoChoose = "Blox Fruits"

_G.Discord = "https://discord.com/invite/3pPEwMKqjD"
_G.YouTube = "https://www.youtube.com/@EW-OS-RAD"
notis = require(game.ReplicatedStorage:WaitForChild("Notification"))
notis.new("<Color=Blue>Thank You Use Xcyro Hub<Color=/>"):Display()
_G.SafeFarm = true
...
local Xcyro = Instance.new("ScreenGui")
Xcyro.Name = "Xcyro"
Xcyro.Parent = game.CoreGui
Xcyro.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
...
--------------------------------------------------------------------------------------------------------
local Library = Update:Window(" Xcyro Hub","BLOX FRUIT",Enum.KeyCode.RightControl);
--------------------------------------------------------------------------------------------------------
local Xcyro = Library:AddTab("Information","rbxassetid://17416719866")
...
--------------------------------------------------------------------------------------------------------
Xcyro:AddSeperator("Xcyro Hub")
Xcyro:UserXcyro()
local Creator = Xcyro:AddLabel('Hello '..game.Players.LocalPlayer.Name.." To Xcyro Hub Thanks Using")

spawn(function()
    while wait() do
        pcall(function()
            if game.Players.LocalPlayer.Name == "Xcyro Hub" then
...
Xcyro:AddSeperator("Developer")
Xcyro:AddLabel("Xcyro Hub")
Xcyro:AddSeperator("Social Network")
Xcyro:AddButton('Discord Sever', function()
setclipboard(_G.Discord)
end)
Xcyro:AddButton('YouTube Official', function()
...
Settings:AddToggle("Disabled Notifications Text",false,function(Xcyro)
_G.Remove_trct = Xcyro
end)
...
task.spawn(function()
	while task.wait() do
		pcall(function()
			if Xcyro and _G.BringMonster then
				for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
					if not string.find(v.Name,"Boss") and (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= _G.BringMode then
						if InMyNetWork(v.HumanoidRootPart) then
...
local Xcyro = Status:AddLabel("N/A")
task.spawn(function()
	while task.wait() do
		pcall(function()
			if game.Workspace.Map:FindFirstChild("KitsuneIsland") then
				Xcyro:Set("🏝 Kitsune Island:  ✅")
			else
				Xcyro:Set("🏝 Kitsune Island:  ❌")
			end
		end)
...
----------------------------------------------------------------------------------------------------------------------------------------
Notification.Notify("Notification", "Thank You For Using Xcyro Hub", "rbxassetid://17416719866", {
    Duration = 5,       
    Main = {
        Rounding = true,
    }
...
wait(6)
Notification.Notify("Notification", "If You Use Fluxus Xcyro Hub Will Very Good", "rbxassetid://17416719866", {
    Duration = 10,       
    Main = {
        Rounding = true,
    }
